...
export default function ContactForm({ audit = false }: { audit?: boolean }) {
  ...
  return <form className="contact-form" onSubmit={submit}>
    ...
    <label>Czego potrzebujesz?<select required name="projectType" defaultValue=""><option value="" disabled>Wybierz najbliższą odpowiedź</option><option>Strona dla warsztatu lub detailingu</option><option>Strona dla firmy remontowej lub instalatora</option><option>Nowa strona dla innej firmy usługowej</option><option>Modernizacja obecnej strony</option><option>Formularz wyceny lub zgłoszenia</option><option>Chatbot dla firmy</option><option>Potrzebuję krótkiej konsultacji</option></select></label>
