...
export default function OfferPage() {
  return <><SiteHeader /><main>
    ...
    <section className="section crm-offer"><div className="shell crm-offer-grid"><div><span className="section-no">MAŁY CRM — WAŻNY FILAR OFERTY</span><h2>Strona zdobywa kontakt. Mały CRM pilnuje, żeby firma go nie zgubiła.</h2><p>Porządkuje klientów, zapytania, wyceny, statusy zleceń, terminy i następne działania. Może działać samodzielnie albo razem ze stroną i formularzami.</p></div><div><b>od 2 900 zł netto</b><span>zwykle 2–4 tygodnie</span><Link className="button" href="/maly-crm-dla-firm">Zobacz Mały CRM <i>↗</i></Link></div></div></section>
