...
const data = {
  ...
  beauty: {
    ...
    outcomes: ["czytelna oferta i portfolio poza marketplace", "widget lub przycisk rezerwacji Booksy na stronie", "chatbot kierujący do właściwej usługi w Booksy", "mniej powtarzalnych pytań przed wizytą"],
