...
const clauses = [
  ...
  ["6. Wynagrodzenie i rozliczenie", "Cena oraz sposób płatności są wskazane w ofercie. Po akceptacji zakresu Klient wpłaca zaliczkę w wysokości 30% uzgodnionego wynagrodzenia; rozpoczęcie realizacji następuje po jej zaksięgowaniu, chyba że strony postanowią inaczej. Pozostała część jest rozliczana zgodnie z etapami zapisanymi w ofercie albo przez uzgodnioną platformę pośredniczącą, np. Useme. Koszty zewnętrzne, takie jak domena, płatne licencje, płatne wtyczki, hosting, sesja zdjęciowa czy płatne narzędzia, są ujmowane wyłącznie wtedy, gdy zostały wyraźnie zaakceptowane."],
