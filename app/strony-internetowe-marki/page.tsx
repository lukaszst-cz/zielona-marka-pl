...
export const metadata: Metadata = { title: "Strony internetowe Marki i okolice", description: "Strony WWW, formularze wyceny, modernizacja i asystenty dla lokalnych firm z Marek, Ząbek, Zielonki, Kobyłki, Targówka i Bródna.", alternates: { canonical: "/strony-internetowe-marki" } };
