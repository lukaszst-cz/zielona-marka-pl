...
export default function DomSite() {
  return (
    <main className="dom-site">
      <nav className="dom-nav"><Link className="dom-brand" href="/"><i>DD</i><span>DOM<br/><b>DOBRY</b></span></Link><div><a href="#inwestycja">Inwestycja</a><a href="#lokale">Lokale</a><a href="#standard">Standard</a></div><a href="#kontakt">Zapytaj o lokal ↗</a></nav>
      ...
      <footer className="dom-footer"><Link className="dom-brand" href="/"><i>DD</i><span>DOM <b>DOBRY</b></span></Link><p>Projekt koncepcyjny Zielonej Marki.</p><Link href="/demo/dom">Zobacz panel sprzedaży ↗</Link></footer>
    </main>
  );
}
