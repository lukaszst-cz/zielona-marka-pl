...
export default function TransportDemo(){
  ...
  return <main className="transport-demo">
    <header><Link className="brand" href="/"><img className="brand-logo" src="/logo.png" alt=""/><span>ZIELONA MARKA</span></Link><span className="demo-badge">INTERAKTYWNE DEMO · DANE PRZYKŁADOWE</span><Link href="/#kontakt">Zapytaj o wdrożenie ↗</Link></header>
