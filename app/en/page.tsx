...
const offers = [
  ["ZM Start", "from PLN 2,490 net", "A focused one-page website for a local business, built to move visitors from Google to a call or enquiry."],
  ["ZM LeadFlow", "from PLN 4,490 net", "A website plus a qualifying enquiry form that collects the information needed for a first conversation, quote or booking."],
  ["ZM Flow AI", "from PLN 6,900 net", "A website, qualifying form and assistant connected to a simple enquiry workflow for the business."],
];
...
export default function EnglishPage() {
  return <main className="english-site" lang="en">
    <header className="site-header">
      <nav className="nav shell" aria-label="Main navigation">
        ...
        <details className="mobile-menu">
          ...
          <div><a href="#work">Work</a><a href="#offer">Offer</a><a href="#systems">Systems</a><a href="#process">Process</a><a href="#contact">Contact</a></div>
        </details>
      </nav>
    </header>
    ...
    <section className="section tech-section"><div className="shell"><div className="section-head"><div><span className="section-no">TOOLS THAT FIT</span><h2>Simple when simple is enough. Scalable when it matters.</h2></div><p>The technology is selected after the business goal is clear. The client should see a reliable result, not a list of frameworks.</p></div><div className="english-tools"><article><b>Website</b><span>A fast, maintainable setup matched to how often the content needs to change.</span></article><article><b>Workflow</b><span>Forms, reminders, statuses and integrations only where they remove real manual work.</span></article><article><b>Client area</b><span>Project status, files, approvals and next steps in one clear place when the service needs it.</span></article></div></div></section>
